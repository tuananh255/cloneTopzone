        ...
        <div className={cx('main')}>
            <div className={cx('form_search header_row d-flex align-items-center justify-content-between')}>
                ...
                <div className="search_input">
                    <input type="text" placeholder='Tìm kiến sản phẩm ...' onChange={()=>setSearchValue(true)}/>
                </div>
                <div style={{background:"#101010"}} className={cx('close_btn')} onClick={()=>{
                    // khi xóa thì cho ẩn hết
